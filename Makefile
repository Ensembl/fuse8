...
SRCS = main.c running.c request.c source.c sourcelist.c interface.c syncsource.c util/misc.c sources/file2.c sources/meta.c jpf/util.c jpf/parse.c jpf/emit.c util/assoc.c util/array.c util/path.c interfaces/fuse.c util/strbuf.c sources/http/client.c sources/http/http.c util/logging.c config.c util/ranges.c util/hash.c util/event.c util/queue.c syncif.c util/dns.c sources/http/connection.c sources/cache/file.c sources/cache/cache.c sources/cache/mmap.c failures.c
